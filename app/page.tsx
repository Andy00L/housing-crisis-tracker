...
export default function Page() {
  ...
  const [lens, setLens] = useState<DimensionLens>("zoning");
    ...
    <>
      ...
      >
        <div className="max-w-5xl mx-auto px-8 pt-20 pb-24">
          ...
          <h2 className="text-3xl md:text-4xl font-semibold text-ink tracking-tight leading-[1.1] mb-10">
            Every housing bill we&rsquo;re tracking
          </h2>
          <FadeInOnView>
            <LegislationTable
              dimension={dimension}
      ...
      >
        <div className="max-w-5xl mx-auto px-8 pt-20 pb-24">
          ...
          <p className="text-[15px] text-muted leading-relaxed max-w-[42rem] mb-10">
            Major residential development projects across Canada, tracked
            from proposal through construction to completion. Includes Build
            Canada Homes sites, CMHC co-funded developments, and large private
            builds.
          </p>
          <FadeInOnView>
            <ProjectsOverview onNavigateToEntity={handleNavigateToEntity} />
          </FadeInOnView>
        </div>
      </section>
      ...
      <section className="relative z-10 bg-white border-t border-black/[.06]">
        <div className="max-w-5xl mx-auto px-8 py-10 flex flex-wrap items-center justify-between gap-4 text-xs text-muted">
          <span>Housing Crisis Tracker</span>
