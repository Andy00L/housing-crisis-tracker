    ...
    <main className="min-h-screen bg-bg">
      <div className="max-w-5xl mx-auto px-8 py-14">
        ...
        <h1 className="text-4xl font-semibold text-ink tracking-tight leading-[1.05] mb-2">
          Every housing project we&rsquo;re tracking
        </h1>
        <p className="text-sm text-muted mb-10">
          Operational, under construction, and proposed residential developments.
        </p>
        <ProjectsOverview onNavigateToEntity={handleNavigate} showAll />
      </div>
    </main>
  );
}
