...
import ProjectsList from "@/components/panel/ProjectsList";
...
export default async function ProjectsPage({
  ...
  const { projects, groupBy } = projectsForEntity(entity);
        ...
        <div className="mb-10">
          ...
          <div className="mt-3 flex flex-wrap items-center gap-3">
            <div className="flex items-center gap-1.5">
              ...
              <StanceBadge stance={entity.stanceZoning} size="md" />
            </div>
...
export function generateStaticParams() {
  return ENTITIES.filter((e) => projectsForEntity(e).projects.length > 0).map(
    (e) => ({ id: e.id }),
  );
}
