...
import HousingMetricsSection from "./HousingMetricsSection";
import { projectsForEntity } from "@/lib/projects-map";
...
export default function SidePanel({
  ...
  // housing metric (NHPI, starts, vacancy, rent, etc.).
  const hasMetrics =
    !!entity?.housingMetrics &&
    Object.values(entity.housingMetrics).some(
      ...
      {projectMode && project ? (
        ...
        <div className="flex-1 flex items-center justify-center px-8 py-12 min-h-[160px]">
          <p className="text-xs text-muted text-center">
            Select a region to see its housing policies and metrics
          </p>
        </div>
      ) : (
          ...
          <div className="p-6 flex flex-col gap-6">
            ...
            {availableLayers.length > 0 && (
              ...
              >
                ...
                {activeLayer === "metrics" && hasMetrics && entity.housingMetrics && (
                  <motion.section layout>
                    <HousingMetricsSection metrics={entity.housingMetrics} />
                  </motion.section>
                )}
              </MotionConfig>
            )}
