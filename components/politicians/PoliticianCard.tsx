...
const STANCE_STORY: Record<StanceType, { chip: string; line: string; dot: string }> = {
  restrictive: {
    ...
    line: "Pushes for stricter housing regulations.",
  ...
  favorable: {
    ...
    line: "Favors pro-development housing policy.",
    dot: "bg-stance-favorable",
  },
  none: {
    chip: "No public stance",
    line: "No public position on housing policy.",
    dot: "bg-stance-none",
  },
};
 ...
 */
const AI_KEYWORDS = /(housing|zoning|affordable|rent|tenant|homelessness|development)/i;
    ...
    <div className="px-5 pb-5 pt-1 flex flex-col gap-7 border-t border-hairline">
      ...
      {!hasVotes && !hasSponsored && stance === "none" && !p.summary && (
        <p className="text-sm text-muted leading-snug max-w-prose">
          No public stance, sponsored bills, or recorded floor votes on
          housing policy on file. Most members of Congress sit
