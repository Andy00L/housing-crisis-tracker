 ...
 *  - data/legislation/federal-us.json  (adds `voteTally` to each bill)
 *  - data/politicians/us-enriched.json  (adds `votes[]` + `alignment`)
 *
 * Pulls from:
 *   data/votes/federal-us.json
...
const FEDERAL_BILLS = "data/legislation/federal-us.json";
const VOTES = "data/votes/federal-us.json";
