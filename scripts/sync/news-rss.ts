...
async function summarize(
  ...
  const system =
    "You write one- to two-sentence neutral summaries of news stories about housing policy, affordability, and residential development. Plain factual prose. No editorializing.";
