...
const TARGETS: EntitySpec[] = [
  ...
  // Canadian provinces are populated by scripts/sync/province-housing-research.ts
  // and written to data/legislation/provinces/{CODE}.json (not data/international/).
];
  ...
  "legislation": [
    {
      ...
      "stance": "restrictive" | "concerning" | "review" | "favorable" | "none",
      "impactTags": [],
      "category": "zoning-reform" | "building-code" | "affordable-housing" | "tenant-protection" | "homelessness-services" | "development-incentive" | "transit-housing" | "property-tax" | "foreign-buyer" | "rent-regulation",
