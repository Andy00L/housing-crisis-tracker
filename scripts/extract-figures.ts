 ...
 * Writes: data/figures/federal-us.json
...
const OUT_FEDERAL = join(ROOT, "data/figures/federal-us.json");
...
function main() {
  ...
  console.log(
    `[extract-figures] wrote ${federalFigures.length} federal figures → data/figures/federal-us.json`,
  );
