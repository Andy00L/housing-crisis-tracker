...
function buildIndex(): SearchItem[] {
  ...
  for (const entity of ENTITIES) {
    // Canadian provinces use the "provinces" view; US states use "states"
    const isCanadianProvince = entity.level === "state" && entity.geoId.startsWith("CA-");
    const naView: NaView = entity.level === "state"
      ? (isCanadianProvince ? "provinces" : "states")
      : "countries";
